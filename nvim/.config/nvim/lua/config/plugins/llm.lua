    ...
    opts = {
      ...
      providers = {
        deepseek = {
          ...
          model = os.getenv('DEEPSEEK_API_CHAT_MODEL'),
          extra_request_body = {
            temperature = 0,
            max_tokens = 8192,
          },
          ...
          http = {
            deepseek = function()
              return require('codecompanion.adapters').extend('deepseek', {
                ...
                schema = {
                  model = {
                    default = vim.env.DEEPSEEK_API_CHAT_MODEL,
                    choices = {
                      [vim.env.DEEPSEEK_API_CHAT_MODEL] = { formatted_name = 'DeepSeek Chat', opts = { can_use_tools = false } },
                    },
                  }
                }
              })
